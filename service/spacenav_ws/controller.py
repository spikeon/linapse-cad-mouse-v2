        ...
        while True:
            ...
            if self.focus and self.subscribed:
                ...
                if isinstance(event, ButtonEvent):
                    # Linapse: ignore button events so they don't snap the view to front.
                    continue

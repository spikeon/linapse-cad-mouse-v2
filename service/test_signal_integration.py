...
def test_motion_bounds_scaling_inversion_and_invalid(running_service):
    ...
    async def run():
        ...
        # Calculation:
        # X: 10.0 is positive, so it scales by x_neg (0.5) -> 5.0, invert -> -5.0. ix = -5
        # Y: -20.0 * 0.8 = -16.0. Spacenav mapping: y = -y = 16.0. iy = 16
        # Z: 5.0 is positive, so it scales by z_neg (0.2) -> 1.0, invert -> -1.0. Spacenav mapping: z = -z = 1.0. iz = 1
        # RX: 2.0. irx = 2
        ...
        # x = 1.0 is positive, so it scales by x_neg (0.5) -> 0.5, invert -> -0.5 -> round -> 0. ix = 0
        # y = 1.0 * 1.5 = 1.5, mapping: y = -y = -1.5 -> round -> -2. iy = -2
        # z = 1.0 is positive, so it scales by z_neg (0.2) -> 0.2, invert -> -0.2, mapping: z = -z = 0.2 -> round -> 0. iz = 0
        # rx = 1.0. irx = 1
